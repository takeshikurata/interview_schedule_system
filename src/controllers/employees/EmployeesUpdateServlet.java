...
public class EmployeesUpdateServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(_token != null && _token.equals(request.getSession().getId())) {
            ...
            // 重複チェックを行う指定をする
            Boolean employeeCodeDuplicateCheckFlag = true;
            if(e.getEmployee_code().equals(request.getParameter("employee_code"))) {
                employeeCodeDuplicateCheckFlag = false;
            } else {
            ...
            List<String> errors = EmployeeValidator.validate(e, employeeCodeDuplicateCheckFlag, passwordCheckFlag);
            if(errors.size() > 0) {
